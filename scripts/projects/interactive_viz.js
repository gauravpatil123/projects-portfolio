...
var evaluation_text6 = "Further, I blurred the senate seats which were not contested in the current election cycle as shown in Fig #22, but nevertheless provide information in the form of tooltips when hovering over these seats. This was to provide the user with an intuitive way to infer which seats were contested in the current election cycle while simultaneously not losing the ability to look up information about the other seats.";
...
var evaluation_text11 = "Further, I listed the major events behind a horizontal scroll interaction, this adds to the interactivity of the visualization. The user may choose to look & explore the major events and scroll back for the visual representation of the seats at his pace and needs.";
